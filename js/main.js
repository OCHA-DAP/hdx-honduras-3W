...
var geodataCall = $.ajax({
    type: 'GET',
    dataType: 'json',
    url: 'data/honduras.json',
});

var dataCall = $.ajax({
    type: 'GET',
    dataType: 'json',
    url: 'https://proxy.hxlstandard.org/data.json?strip-headers=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F1kl6KQ_cK0JtXhYqC4_q3RtfdbJVHFs40YsfA7I6N4VA%2Fedit%23gid%3D917699444&force=on'
});

var dateCall = $.ajax({
    type: 'GET',
    dataType : 'JSON',
    url : 'https://proxy.hxlstandard.org/data.json?strip-headers=on&url=https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2F1kl6KQ_cK0JtXhYqC4_q3RtfdbJVHFs40YsfA7I6N4VA%2Fedit%23gid%3D1900169490&force=on',
});
